...
Процедура ПроверитьДоступностьЭлементов();
	Блокировать = НЕ ЗначениеЗаполнено(Объект.ДатаВыдачи);
	Элементы.МодификаторыСтоимостиСтоимостьЗолото.Доступность = Блокировать;
	Элементы.МодификаторыСтоимостиСтоимостьСеребро.Доступность = Блокировать;
	Элементы.СтоимостьЗолото.Доступность = Блокировать;
	Элементы.СтоимостьСеребро.Доступность = Блокировать;
КонецПроцедуры
